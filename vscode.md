...
[!IMPORTANT]
> The development container assumes you are on a system with uid 1000 and gid 1000. If this isn't the case,
...
[!IMPORTANT]
> If you're behind a corporate proxy that intercepts TLS with a
> self-signed root CA, export that CA certificate (PEM or .crt format)
> into .devcontainer/certs/ before building the dev container. That
> directory is gitignored — nothing placed there is ever committed or
> pushed. If you're not behind such a proxy, you can ignore this
> entirely; the container builds and runs normally without it.
